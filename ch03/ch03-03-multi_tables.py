...
# -----------------------------------
# データの読み込み
train = pd.read_csv('kagglebook-master/input/ch03/multi_table_train.csv')
product_master = pd.read_csv('kagglebook-master/input/ch03/multi_table_product.csv')
user_log = pd.read_csv('kagglebook-master/input/ch03/multi_table_log.csv')
