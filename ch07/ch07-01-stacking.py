...
train = pd.read_csv('kagglebook-master/input/sample-data/train_preprocessed.csv')
train_x = train.drop(['target'], axis=1)
train_y = train['target']
test_x = pd.read_csv('kagglebook-master/input/sample-data/test_preprocessed.csv')

# neural net用のデータ
train_nn = pd.read_csv('kagglebook-master/input/sample-data/train_preprocessed_onehot.csv')
train_x_nn = train_nn.drop(['target'], axis=1)
train_y_nn = train_nn['target']
test_x_nn = pd.read_csv('kagglebook-master/input/sample-data/test_preprocessed_onehot.csv')
